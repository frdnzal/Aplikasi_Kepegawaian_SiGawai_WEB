...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="min-height: 100vh">
      ...
      <a href="{{ route('pegawai.create') }}" class="btn btn-primary mb-4" style="width: fit-content;">Tambah Pegawai</a>
      ...
      <div class="table-responsive small">
        ...
        <tr>
            ...
            <td>
                ...
                <br>
                <a href="{{ route('pegawai.edit', $pegawai->id) }}" class="btn btn-sm btn-warning">
